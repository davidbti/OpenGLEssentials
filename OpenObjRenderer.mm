...
std::vector<unsigned short> objElements;
...
- (GLuint) buildVAO
{
    ...
    glBufferData(GL_ELEMENT_ARRAY_BUFFER, objElements.size() * sizeof(unsigned int), &objElements[0] , GL_STATIC_DRAW);
...
- (id) initWithDefaultFBO: (GLuint) defaultFBOName
{
	if((self = [super init]))
	{
        ...
        indexVBO(vertices, uvs, normals, objElements, objPositions, objTexcoords, objNormals);
