...
@interface OpenTexture1Renderer ()
...
@implementation OpenTexture1Renderer

static const GLfloat texture1Positions[] = {
...
static const GLfloat texture1Texcoords[] = {
    0.000059f, 0.000004f,
    0.000103f, 0.336048f,
    0.335973f, 0.335903f,
    1.000023f, 0.000013f,
...
- (void) render
{
    ...
    glDrawElements(GL_TRIANGLES, sizeof(texture1Elements), GL_UNSIGNED_INT, 0);
...
- (GLuint) buildVAO
{
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(texture1Positions), texture1Positions, GL_STATIC_DRAW);
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(texture1Texcoords), texture1Texcoords, GL_STATIC_DRAW);
    ...
    glBufferData(GL_ELEMENT_ARRAY_BUFFER, sizeof(texture1Elements), texture1Elements, GL_STATIC_DRAW);
...
- (id) initWithDefaultFBO: (GLuint) defaultFBOName
{
	if((self = [super init]))
	{
		...
		filePathName = [[NSBundle mainBundle] pathForResource:@"texture" ofType:@"tga"];
